...
// --- DATA PROYEK ---
// Edit dan tambahkan proyek Anda di sini.
// Pastikan path 'imageSrc' sesuai dengan file di folder 'public/projects/'.
const PROJECTS_DATA = [
  {
    year: "2024",
    title: "Merva Dashboard",
    imageSrc: "/projects/merva-dashboard.jpg", // Ganti dengan nama file Anda
    url: "https://example.com",
    description: "Modern data analytics dashboard with real-time visualization and advanced reporting.",
    details: [ // Gunakan array untuk bullet points
  ...
  },
  {
    year: "2023",
    title: "Ultraformula",
    imageSrc: "/projects/ultraformula.jpg", // Ganti dengan nama file Anda
    url: "https://example.com",
    description: "High-performance math formula editor and solver with LaTeX support.",
    details: [
  ...
  },
  {
    ...
    imageSrc: "/projects/hafari-indonesia.jpg", // Ganti dengan nama file Anda
    url: "https://example.com",
    description: "Platform for Indonesian Islamic community.",
    details: null, // Kosongkan jika tidak ada bullet points
  ...
  },
  {
    year: "2025",
    title: "DakonClash",
    imageSrc: "/projects/dakon-clash.jpg", // Ganti dengan nama file Anda
    url: "https://example.com",
    description: "Modern take on traditional Dakon game with online multiplayer.",
    details: null,
        ...
        {filteredProjects.map(project => (
          ...
          >
            ...
            <div className="relative overflow-hidden">
              <img src={project.imageSrc} alt={`Screenshot of ${project.title}`} className="w-full h-auto transition-transform duration-500 group-hover:scale-105" />
            ...
            <div className="p-6 flex flex-col flex-grow">
              <p className="text-sm text-slate-400 flex-grow">{project.description}</p>
              {project.details && (
